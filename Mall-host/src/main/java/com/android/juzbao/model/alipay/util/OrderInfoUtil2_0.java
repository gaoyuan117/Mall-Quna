...
import com.android.juzbao.model.alipay.SignUtils;
...
public class OrderInfoUtil2_0 {
   ...
   */
  public static Map<String, String> buildOrderParamMap(String app_id, String total_amount, String
      content, String out_trade_no) {
    Map<String, String> keyValues = new HashMap<String, String>();
    //支付包分发非开发者的app_id，必须
    keyValues.put("app_id", app_id);
    //业务参数集合
    ...
    //支付宝异步回调地址
    keyValues.put("notify_url", Endpoint.HOST + "/Api/Notify");
    return keyValues;
  }
  ...
  private static String getBizContent(String total_amount, String content, String out_trade_no) {
    ...
    builder.append("\"order_ids\":").append("\"").append("预留").append("\"").append("}");
