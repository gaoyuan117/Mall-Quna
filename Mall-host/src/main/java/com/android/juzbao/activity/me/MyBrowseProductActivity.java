 ...
 * </p>
 *
 * @ClassName:MyBrowseProductActivity
 * @author: wei
 * @date: 2015-11-10
 */
@EActivity(R.layout.activity_my_favorite_product)
public class MyBrowseProductActivity extends SwipeBackActivity implements
    ...
    public void onRecvMsg(MessageData msg) throws Exception {
        if (msg.valiateReq(FavoriteService.BrowseProductsRequest.class)) {
        ...
        }else if (msg.valiateReq(FavoriteService.DelProductBrowseRequest.class)){
    ...
    private void refreshData(boolean isPullRefresh) {
        ...
        FavoriteBusiness.queryProductBrowse(getHttpDataLoader(),
    ...
    public void onClickDelete(int position) {
        FavoriteBusiness.delProductBrowse(getHttpDataLoader(),
