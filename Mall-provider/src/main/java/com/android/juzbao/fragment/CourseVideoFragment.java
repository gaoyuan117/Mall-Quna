...
import com.android.juzbao.adapter.CourseVideoAdapter;
...
public class CourseVideoFragment extends BaseFragment implements
    ...
    @ViewById(resName = "gvew_video_show")
    GridView mListView;
    ...
    public void onRecvMsg(MessageData msg) throws Exception {
        ...
        if (msg.valiateReq(ShopService.CourseListRequest.class)) {
            ...
            if (CommonValidate.validateQueryState(getActivity(), msg, response)) {
                ...
                if (null == mAdapter) {
                    mAdapter =
                            new CourseVideoAdapter(getActivity(),
                                    mPageInditor.getAll());
    ...
    public void refreshData(boolean isPullRefresh) {
        ...
        ProviderShopBusiness.queryCourse(getHttpDataLoader(),
                CourseType.VIDEO.getValue(), mPageInditor.getPageNum());
    }
